...
const jobs = [
  ...
  },
  {
    ...
    responsibilities: [
      ...
      'Work on CAN CiA 402 communication protocols for robust, real-time communication between robot controllers and peripherals.',
    ...
    requiredSkills: [
      'Excellent programming skills in Python and C++ in a Linux environment.',
      'Strong hands-on experience with ROS 2 node creation, lifecycle management, and system architecture.',
      'Proficiency in trajectory planning and inverse kinematics using MoveIt 2.',
      'Experience building and managing Digital Twins with Gazebo and RViz.',
      'In-depth knowledge of ROS Control, including controller management and resource allocation.',
      'Hands-on experience with HAL (Hardware Abstraction Layer) development and hardware resource managers.',
      'Experience with containerising applications using Docker for robust deployment.',
      'Familiarity with CAN CiA402 protocol for industrial robot communication.',
